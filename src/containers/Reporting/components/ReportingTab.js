  ...
  return (
    <>
      <div className="hidden mt-16 xl:flex justify-between items-center border-t border-gray-300 bg-gray-100">
        <div
          className={`border-l border-r flex flex-col justify-center border-gray-300 h-44 w-44 xl:w-full cursor-pointer ${activeFilter === 'STX+USD' ? 'bg-white' : 'bg-gray-100 border-b'}`}
        ...
        <div
          className={`border-r flex flex-col justify-center border-gray-300 h-44 w-44 xl:w-full cursor-pointer ${activeFilter === 'STX GRANTS' ? 'bg-white' : 'bg-gray-100 border-b'}`}
        ...
        <div
          className={`border-r flex flex-col justify-center border-gray-300 h-44 w-44 xl:w-full cursor-pointer ${activeFilter === 'USD GRANTS' ? 'bg-white' : 'bg-gray-100 border-b'}`}
        ...
        <div
          className={`border-r flex flex-col justify-center border-gray-300 h-44 w-44 xl:w-full cursor-pointer ${activeFilter === 'USD FUNDED' ? 'bg-white' : 'bg-gray-100 border-b'}`}
        ...
        <div
          className={`border-r flex flex-col justify-center border-gray-300 h-44 w-44 xl:w-full cursor-pointer ${activeFilter === 'STX FUNDED' ? 'bg-white' : 'bg-gray-100 border-b'}`}
