...
export default function GrantOverviewTable({ grant, onClose, type }) {
  return (
    <div className="z-50">
      ...
      <div className={`border-l border-r border-b border-gray-300 rounded-b-md ${type === "modal" ? 'max-h-96 overflow-y-scroll scrollbar scrollbar-w-2 scrollbar-track-gray-300 scrollbar-thumb-gray-800 scrollbar-thumb-rounded-full' : ''}`}>
