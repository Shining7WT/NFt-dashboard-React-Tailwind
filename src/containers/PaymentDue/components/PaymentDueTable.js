...
const PaymentDueTable = ({ inputData, handleSort, loading, setShowSTXAddress, setMarkAsFundedModal, handleRowClick }) => {
      ...
      Cell: ({ row }) => (
        <div className="inline-flex justify-end items-center w-full">
          <button
            ...
            onClick={(e) => { e.stopPropagation(); (row.original.funded && setMarkAsFundedModal(true)) }}
          >
